...
const EditImpLink = () => {
  ...
  const [editImplinkData, seteditImplinkData] = useState([]);
  ...
  const master_data_get = async (start_date, end_date, flag, call_id) => {
    ...
    await server_post_data(Edit_get_important_links, fd)
      .then((Response) => {
        if (Response.data.error) {
          handleError(Response.data.message);
        } else {
          seteditImplinkData(Response.data.message[0]);
            ...
            <div className="app-main__inner">
              ...
              <div className="main-card mb-3 card">
                <div className="card-body">
                  <h5 className="card-title">Edit IMP LINK</h5>
                    ...
                    <div className="form-row">
                      <div className="col-md-6 mb-3">
                        ...
                        <input
                          ...
                          defaultValue={editImplinkData.title || ""}
                        />
                    ...
                    <div className="form-row">
                      <div className="col-md-6 mb-3">
                        ...
                        <input
                          ...
                          // onInput={handleAphabetsChange}
                          placeholder="Enter Title"
                          defaultValue={editImplinkData.ImpImageLink || ""}
                        />
                        <span className="condition_error"></span>
                      </div>
                    </div>
