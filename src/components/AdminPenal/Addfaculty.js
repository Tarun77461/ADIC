            ...
            <div className="app-main__inner">
              ...
              <div className="main-card mb-3 card">
                <div className="card-body">
                  ...
                  <form className="needs-validation" id="facultyformData">
                      ...
                      <div className="col-md-6 mb-3">
                        ...
                        <div className="previewEditBox">
                          {dynaicimage && dynaicimage.Image_url_show && (
                            <img
                              src={"media/" + dynaicimage.Image_url_show}
                              alt={dynaicimage.Image_url}
                    ...
                    <div className="form-row">
                      <div className="col-md-6 mb-3">
                        <label htmlFor="validationCustom01">
                          Responsibility<span className="red_show">*</span>
                        </label>
                        <input
                          type="text"
                          className="form-control  trio_mandatory"
